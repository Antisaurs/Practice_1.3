...
read_excel('E:/reef_fish.xlsx') # automatically print on my screen
fish<-read_excel('E:/reef_fish.xlsx') # store my table in an object called `fish`
fish # print my object `fish`   

install.packages("readxl")
library(readxl)
read_excel('E:/reef_fish.xlsx')
fish<-read_excel('E:/reef_fish.xlsx')
fish

## # import file by path name
## fish<-read.table ("E:\reef_fish.txt",header = TRUE,sep="\t", dec=".")# long version
## fish<-read.table("E:\reef_fish.txt", TRUE, "\t",".")# short version
...
fish<-read.table('E:/reef_fish.txt', header=T, sep='\t', dec='.')
